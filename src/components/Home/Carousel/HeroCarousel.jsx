...
import watch1 from "../../../assets/images/CarouselImages/watch1.png";
...
const HeroCarousel = () => {
  const slides = [
    ...
    {
      title: "Elegant Classic Wrist Watch for Every Occasion",
      subtitle: "Stylish and durable watch designed to complement your everyday look",
      image: watch1
    },
    {
